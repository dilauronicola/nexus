        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarrantyStart = table.Column<DateOnly>(type: "date", nullable: true),
                    WarrantyEnd = table.Column<DateOnly>(type: "date", nullable: true),
                    PurchaseInfo_Supplier = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    PurchaseInfo_InvoiceNumber = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    PurchaseInfo_PurchaseDate = table.Column<DateOnly>(type: "date", nullable: true),
                    PurchaseInfo_PurchasePrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssetCredentials_Assets_AssetId",
                        column: x => x.AssetId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NetworkInterfaces_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetCredentials_AssetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_PartyId_LastName_FirstName",
                table: "Contacts",
                columns: new[] { "PartyId", "LastName", "FirstName" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NetworkInterfaces_AssetId",
